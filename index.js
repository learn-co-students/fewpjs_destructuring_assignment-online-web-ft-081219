...
const [Bessie, Dolly, Babe, Little] = farmAnimals.split(' ').filter(e => e !== 'horse');
...
const [black_and_white, black, pink] = farmAnimals.split(' ').filter(e => e !== 'horse');
...
const [r, o, y, g, b, v] = colors.filter(e => e !== 'indigo');
